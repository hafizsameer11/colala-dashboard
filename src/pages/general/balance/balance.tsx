...
const Balance = () => {
  ...
  const usersForExport = useMemo(() => {
    return usersRaw.map((user: any) => ({
      ...
      wallet: {
        shopping_balance: user.shopping_balance || user.wallet?.shopping_balance || 0,
        reward_balance: user.reward_balance || user.wallet?.reward_balance || 0,
        referral_balance: user.referral_balance || user.wallet?.referral_balance || 0,
        ad_credit: user.ad_credit || user.wallet?.ad_credit || 0,
        loyality_points: user.loyalty_points || user.loyality_points || user.wallet?.loyality_points || 0,
      },
