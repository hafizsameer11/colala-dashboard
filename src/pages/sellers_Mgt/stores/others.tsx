        ...
        <div className="flex flex-row justify-between mt-5 gap-5">
          ...
          >
            ...
            <div className="p-5 flex flex-col bg-white rounded-b-2xl gap-5">
              <div className="flex flex-row justify-between">
                ...
                <div>
                  <button className="bg-[#E53E3E] text-white cursor-pointer px-6 py-3.5 rounded-2xl">
                    Add New Code
                  </button>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex flex-row justify-between mt-3">
                  <div className="text-[#00000080] text-md ">Date Created</div>
                ...
                <div className="flex flex-row justify-between mt-3">
                  <div className="text-[#00000080] text-md ">Maximum Usage</div>
              ...
              >
                <div className="text-white text-lg" >Total Points Balance</div>
          ...
          >
            <div className="bg-[#F2F2F2]  p-4 rounded-t-2xl flex flex-row justify-between items-center">
              ...
              <div>
                <button className="bg-[#E53E3E] text-white rounded-xl px-6 py-2 cursor-pointer ">
                  Add New User
                </button>
              </div>
            </div>
