        ...
        <div className="w-full max-w-[400px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 cursor-pointer top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700"
                  disabled={loading}
                >
                  <svg
                    className="w-5 h-5"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full cursor-pointer bg-[#E53E3E] text-white py-4 px-6 rounded-lg font-semibold text-lg hover:bg-[#D32F2F] transition-colors focus:outline-none focus:ring-2 focus:ring-[#E53E3E] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
            >
              {loading ? (
                <>
