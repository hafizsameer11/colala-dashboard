              ...
              >
                ...
                <td className="p-3 space-x-2">
                  <button
                    ...
                    className="bg-[#E53E3E] hover:bg-red-600 text-white px-6 py-2 rounded-2xl cursor-pointer"
                  >
                    Details
                  </button>
                  <button className="bg-black hover:bg-gray-900 text-white px-4 py-2 rounded-2xl cursor-pointer">
                    View Chat
                  </button>
                </td>
              </tr>
