        ...
        <div className="relative rounded-2xl overflow-hidden">
          <img
            src={realProductData.complete.video.startsWith('http') 
              ? realProductData.complete.video 
              : `https://api.colalamall.com/storage/${realProductData.complete.video}`}
              ...
              <img
                src={
                  realProductData.complete.images[currentImageIndex].path.startsWith('http')
                    ...
                    : `https://api.colalamall.com/storage/${realProductData.complete.images[currentImageIndex].path}`
                }
              ...
              <div className="mt-3 flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                {realProductData.complete.images.map((image: any, index: number) => {
                  const thumbUrl = image.path.startsWith('http')
                    ? image.path
                    : `https://api.colalamall.com/storage/${image.path}`;
                  return (
                    <button
                      key={index}
            ...
            <img
              src={
                realProductData.complete.images[selectedImageIndex].path.startsWith('http')
                  ...
                  : `https://api.colalamall.com/storage/${realProductData.complete.images[selectedImageIndex].path}`
              }
